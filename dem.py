...
def instruction_call(arr):
	...
	if((arr[0]=="add" or arr[0]=="sub" or arr[0]=="mul" or arr[0]=="xor" or arr[0]=="or" or arr[0]=="and" ) and arr[1] in listr and arr[2] in listr and arr[3] in listr and len(arr)==4):
	...
	elif((arr[0]=="ls" or arr[0]=="rs" or (arr[0]=="mov" and arr[1][0]=='R' and  arr[2][0]=="$")) and arr[1] in listr and arr[2][0]=="$" and len(arr)==3):
		#move imm in flags??
		a = dic.get(arr[0])
		b = encodeA(arr[1])
		c=arr[2]
	...
	elif(arr[0] == "mov" and arr[1][0]=="R" and arr[2][0]=="R" and arr[1] in listr and arr[2] in listr and len(arr)==3):
	...
	elif(arr[0] == "mov" and arr[1][0]=="R" and arr[2]=="FLAGS" and arr[1] in listr and len(arr)==3):
		a = dic.get("mov1")
		b = encodeC(arr[1])
		c = encodeC(arr[2])
		if(b=='-1' or c=='-1'):
